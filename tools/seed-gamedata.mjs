...
//
// Reads:  ../src/PokemonGreen.Assets/Data/species.json
// Writes: ../src/PokemonGreen.Assets/Data/gamedata.db
...
const ASSETS_DATA = join(__dirname, '..', 'src', 'PokemonGreen.Assets', 'Data')
