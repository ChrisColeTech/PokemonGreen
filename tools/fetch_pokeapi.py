...
Usage:
    python fetch_pokeapi.py [--gen 7] [--output ../src/PokemonGreen.Assets/Content/Data/species.json]
...
def main():
    ...
    if args.output is None:
        ...
        args.output = str(script_dir / "src" / "PokemonGreen.Assets" / "Content" / "Data" / "species.json")
    ...
    session.headers["User-Agent"] = "PokemonGreen-DataFetcher/1.0"
