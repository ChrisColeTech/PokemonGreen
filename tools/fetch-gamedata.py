...
Writes directly to: src/PokemonGreen.Assets/Data/gamedata.db
"""
...
DB_PATH = SCRIPT_DIR.parent / "src" / "PokemonGreen.Assets" / "Data" / "gamedata.db"
...
def create_session() -> requests.Session:
    ...
    session.headers["User-Agent"] = "PokemonGreen-DataFetcher/2.0"
    return session
