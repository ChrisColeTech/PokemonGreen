# 30-PokemonGreen-3D-PROJECT

Overview of the PokemonGreen.3D executable project - the 3D overworld exploration and battle game client.

## Purpose

This project is the main entry point for the 3D Pokemon game experience. It handles:
...
- `PokemonGreen.Core` - All game logic, rendering, UI, and data systems
...
|-----------|-----------|---------|
| `BattleScreen3D` | `PokemonGreen.Core.Battle` | 3D battle scene + UI |
| `Camera3D` | `PokemonGreen.Core.Rendering` | Third-person camera |
| `ThirdPersonInputMapper` | `PokemonGreen.Core.Systems` | Input to camera-relative movement |
| `CubeCollectibleSystem` | `PokemonGreen.Core.Systems` | Coin spawning, animation, collection |
| `PersistenceManager3D` | `PokemonGreen.Core.Save` | JSON file save/load |
| `AnimationController` | `PokemonGreen.Core.Rendering.Skeletal` | Skeletal animation playback |
| `SkinnedDaeModel` | `PokemonGreen.Core.Rendering.Skeletal` | GPU skinned mesh |
| `SplitModelAnimationSetLoader` | `PokemonGreen.Core.Rendering.Skeletal` | Loads split DAE assets |
| `MapRegistry` / `MapCatalog` | `PokemonGreen.Core.Maps` | Map data access |
| `TileRegistry` | `PokemonGreen.Core.Maps` | Tile definition lookup |
| `KermFont` / `KermFontRenderer` | `PokemonGreen.Core.UI.Fonts` | Bitmap font rendering |
| `MessageBox` / `MenuBox` | `PokemonGreen.Core.UI` | UI dialogs |
| `CharacterSelectScreen` | `PokemonGreen.Core.UI.Screens` | Character selection overlay |
...
| Asset Type | Path |
|------------|------|
| Character models | `PokemonGreen.Assets/Pokemon3D/characters/overworld/{folder}/` |
| Battle backgrounds | `PokemonGreen.Assets/BattleBG/` |
| KermFont | `PokemonGreen.Assets/Content/Fonts/Kerm/Battle.kermfont` |
