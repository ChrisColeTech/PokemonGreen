# 32-PokemonGreen-Assets

Reference documentation for the PokemonGreen.Assets folder - contains all game assets loaded at runtime.

## Folder Structure

```
PokemonGreen.Assets/
├── Pokemon3D/           # 3D Pokemon and character models
...
### Battle Pokemon (`pmXXXX_XX/`)

Pokemon battle models extracted from ROM. Each folder contains:
...
| Table | Contents |
|-------|----------|
| `species` | Pokemon species data (stats, types, abilities) |
...
1. **Pokemon:** Extract from ROM using Ohana3DS or Spica, export via `PokemonGreen.OhanaCli`
