...
- Content Pipeline lives in `PokemonGreen.Assets` project (not Core, not game shell)
...
In `src/PokemonGreen/Game1.cs` line 50:
```csharp
...
dotnet build D:\Projects\PokemonGreen
...
| `Assets/PokemonGreen.Assets.csproj` | Added AssimpNet 4.1.0, Content.Builder.Task, BattleBG content copy |
