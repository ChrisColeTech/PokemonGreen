...
namespace SpicaCli.Formats
{
    class GFL2OverWorld
    {
        ...
        public static H3D OpenAsH3D(Stream Input, GFPackage.Header Header, H3DDict<H3DBone> Skeleton = null)
        {
            ...
            ReadModelsBG(Header.Entries[0], Reader, MdlPack);
            ReadModelsBG(Header.Entries[1], Reader, MdlPack);
            ReadModelsBG(Header.Entries[2], Reader, MdlPack);
            ReadModelsBG(Header.Entries[3], Reader, MdlPack);
            ReadModelsBG(Header.Entries[4], Reader, MdlPack);
            ReadAnimsBG(Header.Entries[5], Reader, MotPack);
            ReadAnimsBG(Header.Entries[6], Reader, MotPack);
