...
/// <param name="TargetMapId">The map ID to transition to.</param>
/// <param name="Offset">Position offset along the perpendicular axis.
/// For North/South: added to X. For East/West: added to Y.
/// Example: offset=3 means this map's edge position 0 maps to target position 3.</param>
