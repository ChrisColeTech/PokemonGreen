...
export class QuaternionExtensions {
    static PI_DIVISOR = Math.PI / 65536.0;
    static PI_ADDEND = Math.PI / 4.0;
    static PI_HALF = Math.PI / 2.0;
    static SCALE = 0x7FFF;
    static ExpandFloat(i) {
        return i * (QuaternionExtensions.PI_HALF / QuaternionExtensions.SCALE) - QuaternionExtensions.PI_ADDEND;
    }
    static QuantizeFloat(f) {
    ...
    static ToDictionary(quaternion) {
        return {
            "W": quaternion.W,
            "X": quaternion.X,
            "Y": quaternion.Y,
...
//# sourceMappingURL=QuaternionExtensions.js.map