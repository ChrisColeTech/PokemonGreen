...
using SwitchToolboxCli.Core.Flatbuffers.Converters;
using SwitchToolboxCli.Core.Flatbuffers.Utils;
using System.Text.Json.Serialization;

namespace SwitchToolboxCli.Core.Flatbuffers.TR.Animation
{
